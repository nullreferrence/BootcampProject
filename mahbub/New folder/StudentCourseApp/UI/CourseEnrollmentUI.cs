...
namespace BoothCampStudentCourseApp.UI
{
    public partial class CourseEnrollmentUI : Form
    {
        ...
        private void ShowStudentCourseInListView()
        {
            ...
            {
                ListViewItem anItem = new ListViewItem(studentCoursese.CourseTitle);
        ...
        private void enrollButton_Click(object sender, EventArgs e)
        {
            ...
            //aCourse.CourseID = courseComboBox.SelectedIndex;
            //aCourse.CourseName = courseComboBox.SelectedItem.ToString();
            //aCourse.CourseCode = courseComboBox.ValueMember;
